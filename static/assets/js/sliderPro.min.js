...
function (a, b) {
	...
	var c = "Retina." + b.SliderPro.namespace,
		d = {
			...
			_isRetina: function () {
				return a.devicePixelRatio >= 2 ? !0 : a.matchMedia && a.matchMedia("(-webkit-min-device-pixel-ratio: 2),(min-resolution: 192dppx)").matches ? !0 : !1
			},
...
function (a) {
	"use strict";
	var b = window.navigator.userAgent.match(/(iPad|iPhone|iPos)/g) ? !0 : !1,
		c = function (b, c) {
